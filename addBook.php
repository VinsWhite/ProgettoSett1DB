...
<main>
    <div class="container mt-4">
        ...
        <h3 class="text-warning fw-semibold">Inserisci un libro</h3>
        <div> <!-- N.B. questa sezione sarà disponibile solo se l'utente è loggato -->
            <form  method="POST" action="crud/insert.php" enctype="multipart/form-data"> <!-- Percorso corretto per il file insert.php -->
                <div class="row mb-3">
